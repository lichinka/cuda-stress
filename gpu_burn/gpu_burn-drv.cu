...
*/
		//d_doubles ? 
//		compareD<<<g_blockSize,g_blockSize,1>>>((double*)d_Cdata,(int*)d_faultyElemData,(size_t)d_iters);// : compare<<g_blockSize,g_blockSize,1>>(d_Cdata,d_faultyElemData,d_iters);	
	}
